...
class AsyncAzureCosmosMongoDBCollection:
    __db_client = None
    def __init__(
        self,
...
async def main():
    ...
    await db_client.adelete_collection(collection_name)
    collection1 = db_client.get_collection(collection_name)
